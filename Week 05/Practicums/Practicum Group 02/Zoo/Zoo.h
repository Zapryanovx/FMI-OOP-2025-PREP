...
//
//Да се създаде клас Zoo, който има име с произволна дължина и пази в себе си масив от животни.В конструктора 
// си класът приема стойност за максимален капацитет на масива.Класът да поддържа следните функционалности :
//
